...
with open('data_si_1.npy', 'rb') as file:
    data_1 = np.load(file)
    
with open('data_si_2.npy', 'rb') as file:
    data_2 = np.load(file)   
    
with open('data_si_3.npy', 'rb') as file:
    data_3 = np.load(file) 
    
with open('data_si_4.npy', 'rb') as file:
    data_4 = np.load(file) 
...
def plot_result(data):
    ...
    plt.legend(["SI (LL)", "SI (LH)", "SI (HL)", "SI (HH)"])

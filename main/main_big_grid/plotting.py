...
def plot_result(data):
    ...
    plt.legend(["Q-Learning", "Dyna-Q (replay=10)", "SI agent (N = 1)", "DPEFE agent (N = 50)", "Random agent"])
    plt.title("Performace of agents in grid environment with 470 states")
    
    plt.xlabel("Episode number in trial")
    plt.ylabel("Length of epsiode")
    plt.savefig('perf_biggrid.png', dpi=500, bbox_inches='tight');

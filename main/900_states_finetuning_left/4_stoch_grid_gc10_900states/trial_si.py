...
time_horizon = 20000
env = Env(path = '../environments/grid30.txt', stochastic = True, end_state=369, epi_length_limit = time_horizon)
...
for trial in range(n_trials):
    if(trial%10 == 0):
        ...
        env = Env(path = '../environments/grid30.txt',

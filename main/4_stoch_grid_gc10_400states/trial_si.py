...
time_horizon = 20000
env = Env(path = '../environments/grid20.txt', stochastic = True, end_state=185, epi_length_limit = time_horizon)
...
for trial in range(n_trials):
    if(trial%10 == 0):
        ...
        end_state = 185 if(trial == 0) else end_state
